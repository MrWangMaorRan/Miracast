package com.zizhong.mobilescreen.servicess;
...
//            notificationChannel.enableVibration(true);
        ...
        //通知小图标
        builder.setSmallIcon(R.mipmap.icons_launcher);
        //通知标题
        builder.setContentTitle("手机投屏");
        //通知内容
        builder.setContentText("手机投屏正在运行");
        //设定通知显示的时间
